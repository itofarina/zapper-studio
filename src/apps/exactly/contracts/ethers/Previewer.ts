...
export declare namespace Previewer {
  ...
  export type FixedPoolStructOutput = [BigNumber, BigNumber, BigNumber, BigNumber, BigNumber] & {
    maturity: BigNumber;
    borrowed: BigNumber;
    supplied: BigNumber;
    available: BigNumber;
  ...
  export type FixedPositionStructOutput = [BigNumber, FixedLib.PositionStructOutput] & {
    maturity: BigNumber;
  ...
  export type FixedMarketStruct = {
    market: PromiseOrValue<string>;
    decimals: PromiseOrValue<BigNumberish>;
    assets: PromiseOrValue<BigNumberish>;
    deposits: Previewer.FixedPreviewStruct[];
    borrows: Previewer.FixedPreviewStruct[];
  };

  export type FixedMarketStructOutput = [
    string,
    number,
    BigNumber,
    ...
    decimals: number;
    assets: BigNumber;
    deposits: Previewer.FixedPreviewStructOutput[];
    borrows: Previewer.FixedPreviewStructOutput[];
  };
}
...
export interface PreviewerInterface extends utils.Interface {
  functions: {
    ...
    'previewFixed(uint256)': FunctionFragment;
    'previewRepayAtMaturity(address,uint256,uint256,address)': FunctionFragment;
    'previewWithdrawAtMaturity(address,uint256,uint256)': FunctionFragment;
  };
  ...
  encodeFunctionData(functionFragment: 'previewFixed', values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'previewFixed', data: BytesLike): Result;
...
export interface Previewer extends BaseContract {
  ...
  functions: {
    ...
    previewFixed(
      ...
      [Previewer.FixedMarketStructOutput[]] & {
        data: Previewer.FixedMarketStructOutput[];
      }
    >;
  ...
  previewFixed(
    usdAmount: PromiseOrValue<BigNumberish>,
    overrides?: CallOverrides,
  ): Promise<Previewer.FixedMarketStructOutput[]>;
  ...
  estimateGas: {
    ...
    previewFixed(usdAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    previewFixed(usdAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
